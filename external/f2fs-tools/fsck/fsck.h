...
u32 convert_encrypted_name(unsigned char *, unsigned int, unsigned char *, int);
...
/* defrag.c */
extern int f2fs_defragment(struct f2fs_sb_info *, u64, u64, u64, int);

/* resize.c */
extern int f2fs_resize(struct f2fs_sb_info *);

/* xattr.c */
void *read_all_xattrs(struct f2fs_sb_info *, struct f2fs_node *);
struct f2fs_xattr_entry *find_xattr(void *, int, size_t, const char *);
