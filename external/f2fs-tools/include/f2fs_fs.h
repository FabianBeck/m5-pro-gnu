...
#define file_is_encrypt_corrupt(fi) ((fi)->i_advise & FADVISE_ENCRYPT_CORRUPT_BIT)
#define file_clear_encrypt_corrupt(fi) ((fi)->i_advise &= ~FADVISE_ENCRYPT_CORRUPT_BIT)
#define file_set_encrypt_fixed(fi) ((fi)->i_advise |= FADVISE_ENCRYPT_FIXED_BIT)
